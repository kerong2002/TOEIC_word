...
| beverage | 飲料  |
| motivate | 給與動機；激發  |
| attentive | 細心的；注意的，留意的； 殷勤的，體貼的  |
| virus | 病毒  |
| strength | 力氣；長處  |
| proposition | 建議；(向女性)求歡  |
| wholesale | 批發/批發的；大批的/大批地/批發(貨物)；成批售出  |
| ebullient | 熱情洋溢的；興高采烈的；沸騰的  |
| qualitative | 性質上的  |
| confidence | 信心；自信；信賴  |
| warehouse | 倉庫/把...存入倉庫  |
| estate | 地產；財產  |
...
| curtain | 簾；窗簾 / 給…裝上簾子  |
| exquisite | 精美的/服飾過於講究的男子  |
| shareholder | 股東  |
| product | 產品，產物  |
| commute | (購用月票或季票)通勤；用...交換(或代替); 交換/通勤  |
| tactic | 戰術; 策略; 手法  |
| smuggle | 走私  |
| burglar | 竊賊；夜賊  |
| digest | 消化；領悟  |
...
| specification | 規範，說明書；載明; 詳述；規格; 明細單; 詳細計劃書  |
| employ | 雇用 / 利用；使從事於  |
| approve | 同意；認可  |
| maintenance | 維修  |
| eclectic | 不拘一格的；折衷的/折衷主義者  |
| digital | 數字式的；數位的/電子鐘錶  |
| visitor | 訪問者；探病者；觀光者；參觀者  |
| galaxy | 銀河系  |
| currency | 貨幣；通用  |
...
| involve | 使捲入；需要；使專注  |
| lift | 舉起；抬起；振作(精神)；空運；偷竊；解除；償還；挖出(山芋等)；升起/提；電梯  |
| stationery | 文具  |
| attorney | 律師；法定代理人  |
...
| slogan | 口號；標語  |
| review | 再檢查；回顧 / 複習；複審  |
| result | 結果；戰績 / 起因於…；發生，產生；導致  |
| mingle | 混合；往來  |
| solar | 太陽的  |
| line | 線條；畫線於；行列；航線；一行；皺紋；外型；方式；路線；行業；種類；界線；消息  |
| ground | 地面；土壤；場所；基礎；領域；觀點；根據/擱淺；根據  |
| quote | 引用；把...放在引號內；報價/引文；引號；報價  |
| hacker | 駭客  |
| program | 節目(表)；計畫 / 為...安排節目； 為...制訂計劃  |
| latest | 最近的；最遲的/最新的事物(或發展、消息等)  |
| via | 取道；經由；通道；憑藉  |
...
| welfare | 福利；社會救濟/福利的  |
| tourist | 觀光客/旅遊的/在經濟艙  |
| personnel | 人員； 人事部門; 人事課(或室等)  |
| fringe | 條紋；瀏海；邊緣/附加的  |
| neon | 氖；霓虹燈  |
...
| jeopardy | 危險；風險；危難  |
| residence | 住宅，居住  |
| merchandise | 商品；貨物/經商  |
| quality | 質量，特質，品質 / 優良的，優質的，高級的  |
| sufficient | 充足的/足量  |
| protocol | 協議；禮節；草案/擬定  |
| interest | 利益；興趣；趣味性；利息；股份；重要性/使發生興趣；使參與  |
| playwright | 劇作家  |
| refreshment | 精神恢復，食物和飲料  |
| incentive | 刺激；鼓勵；獎勵  |
| answer | 答案；回答；反應；對應物  |
...
| architect | 建築師；設計師  |
| crash | 發出猛烈聲音地)碰撞  |
| produce | 生產；製造；上映；引起 / 產品；農產品  |
| chore | 例行工作；家務事  |
| carpenter | 木匠/當木匠  |
| sightseeing | 觀光/觀光的；遊覽的  |
| fuel | 燃料/加燃料；給...加油；刺激  |
| dissuade | 勸(某人)勿做某事  |
| generate | 產生；引起  |
| ballet | 芭蕾舞；芭雷舞團  |
...
| extension | 伸長；延長；擴大部分  |
| circular | 環形的；拐彎抹角的/通知  |
...
| approach | 接近，靠近；通道，入口；方法，態度/著手處理；接近；找....商量  |
| jot | 匆匆記下/一點兒；極少  |
| intrude | 入侵，打擾  |
| structure | 結構；建築物/建造  |
| checkout | 付款櫃檯  |
...
| cabin | 客艙；(飛機的)駕駛艙; 客艙；(鐵路的)信號房/住在小屋裡  |
...
| acquisition | 取得；獲得物  |
| display | 展覽  |
| malfunction | 故障；疾病/發生故障  |
| furniture | 傢俱；(工廠等的)設備  |
| observe | 看到；觀察；遵守；說；慶祝(節日等)  |
| asset | 資產，財產；寶貴的人才，有益的品質；有利的條件  |
| factor | 因素；【數】因子/把...分解成  |
| consecutive | 連續不段的；連貫的  |
| flea | 跳蚤  |
| metal | 金屬 /用金屬包; 用金屬裝配  |
...
| depression | 沮喪  |
| lag | 緩慢，落後/落後; 滯後; 衰退  |
| coach | 教練；家庭教師；公車；旅客車廂/訓練；指導；接受輔導  |
| inspire | 鼓舞；賦予...靈感；激起；引起；吸氣  |
| violin | 小提琴；小提琴演奏者  |
| detector | 探測器  |
...
| ordinance | 法令；條例  |
| resentment | 憤怒  |
| raw | 生的； 未加工的；不完美的；陰冷的；新鮮的/擦傷處；不帶手套的雙拳/使赤身裸體  |
| act | 行動；表演  |
| feedback | 反饋；回饋  |
| agenda | 議程，日常工作事項  |
| vacation | 假期；休假；休假日  |
...
| scientist | 科學家；自然科學家  |
| import | 進口；意味著/進口商品；含義；重要性  |
| duplicate | 複製/ 副本的/ 複製品  |
| verify | 證實；證明；核對；查實  |
| alcohol | 酒精  |
| deduction | 推斷；演藝；減除額；扣除  |
| heavenly | 天堂的; 美好的/ 極其  |
| terminology | 術語；專門用語  |
| discard | 摒棄；遺棄  |
| representative | 象徵的；代表的；議會制的/例子；代表  |
| network | 電腦網路；網狀物；廣播網; 電視網/用網覆蓋；在廣播網(或電視網)聯播；建立關係網  |
| irresistible | 不可抗拒；不可壓制的；富有誘惑力的  |
| season | 季節；節期；旺季/加味於；使適應  |
| alleviate | 減輕；緩和  |
| restate | 重申；再聲明；重新敘述  |
| resistance | 反抗；抵抗；電阻器  |
| sibling | 手足；兄弟姊妹  |
| defamation | 誹謗；中傷  |
| fraud | 欺詐罪；詭計；騙子  |
| ticket | 票；標籤；罰單；恰好的事情  |
| appliance | 器具；裝備  |
...
| draft | 草稿；匯票  |
| typist | 打字員  |
| headline | (報紙)標題；頭條新聞；(新聞廣播的)內容提要/給...加標題；大力宣傳；當主角  |
| syndicate | 財團，企業聯合  |
| restriction | 限制;約束  |
| league | 聯盟；盟約/使結盟  |
| tactics | 戰術；策略  |
